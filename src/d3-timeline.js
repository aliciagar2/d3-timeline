                ...
                d.forEach(function (datum, index) {
                    ...
                    g.selectAll("svg").data(data).enter()
                        ...
                        .attr("class", function (d, i) {
                            var timelineClass = datum.class ? "timelineSeries_" + datum.class : "timelineSeries_" + index;
                            return d.class ? timelineClass + " " + d.class : timelineClass;
                        })
